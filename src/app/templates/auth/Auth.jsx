...
import CinnySvg from "../../../../public/res/svg/d.svg";
    ...
    <>
      ...
      {process.isLoading && (
        <div className="homeserver-form__status flex--center">
          <Spinner size="small" />
          <p className={styles.loadingServer}>{process.message}</p>
        </div>
      )}
    </>
  );
...
function Register({ registerInfo, loginFlow, baseUrl }) {
  ...
  return (
    <>
      ...
      <div className={styles.authHeading}>
        {/* {!isDisabled && <h2 className={styles.title}>Register</h2>} */}
        {isDisabled && (
      ...
      <div className={styles.container}>
        <div className={styles.bgWrap}>
          <h2 className={styles.brandTitle}>
            secure and beautiful messaging experience.
          </h2>
          <p className={styles.powered}>
            powered by{" "}
            <a href="https://matrix.org" target="__blank">
              [matrix]
            </a>
          </p>
        </div>
